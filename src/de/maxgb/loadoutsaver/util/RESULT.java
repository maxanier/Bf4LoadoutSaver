...
public class RESULT {
	...
	public final static int NOSESSIONKEY = 2;
	public final static int NOPERSONAID = 3;
	public final static int NOUSERNAME = 4;
	public final static int MISSINGPARAMETER = 5;
