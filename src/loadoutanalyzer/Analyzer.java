...
//			try {
//				writeLoadout(name, analyzeInfantryLoadout(Loadout.getInfantryFromFull(l.getLoadout())), analyzeVehicleLoadout(Loadout.getVehicleFromFull(l.getLoadout())));
//			} catch (IOException e) {e.printStackTrace();}
//			break;
//		case Constants.INFANTRY_TYPE:
//			try {
//				writeLoadout(name, analyzeInfantryLoadout(Loadout.getInfantryFromFull(l.getLoadout())), null);
//			} catch (IOException e) {e.printStackTrace();}
//			break;
//		case Constants.VEHICLE_TYPE:
//			try {
//				writeLoadout(name, null, analyzeVehicleLoadout(Loadout.getVehicleFromFull(l.getLoadout())));
//			} catch (IOException e) {e.printStackTrace();}
//			break;
//		}
//	}
//
//	private static void writeLoadout(String name, InfantryPack ifp, String[][] vep) throws IOException {
...
//		weaponsSKKITS[0] = weaponsSKKITS[0].substring(0, weaponsSKKITS[0].length()-2);
//		
